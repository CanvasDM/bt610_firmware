...
AttributeEntry_t attrTable[ATTR_TABLE_SIZE] = {
    ...
    [3  ] = { RW_ATTRX(advertisingDuration)           , u16, y, n, n, y, AttributeValidator_uint16   , 0, 65535 },
    [4  ] = { RW_ATTRS(passkey)                       , s  , y, n, n, n, AttributeValidator_string   , 0, 0 },
    [5  ] = { RW_ATTRX(lock)                          , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [6  ] = { RW_ATTRX(batterySenseInterval)          , u16, y, n, n, n, AttributeValidator_uint16   , 0, 86400 },
    [7  ] = { RW_ATTRX(temperatureSenseInterval)      , u16, y, n, n, n, AttributeValidator_uint16   , 0, 86400 },
    [8  ] = { RW_ATTRX(temperatureAggregationCount)   , u8 , y, n, n, n, AttributeValidator_uint8    , 1, 32 },
    [9  ] = { RW_ATTRX(digitalOutput1Mv)              , u16, y, n, n, n, AttributeValidator_uint16   , 0, 30000 },
    [10 ] = { RW_ATTRX(digitalOutput2Mv)              , u16, y, n, n, n, AttributeValidator_uint16   , 0, 30000 },
    [11 ] = { RW_ATTRX(digitalInput1)                 , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [12 ] = { RW_ATTRX(digitalInput2)                 , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [13 ] = { RW_ATTRX(analogInput1Type)              , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [14 ] = { RW_ATTRX(analogInput2Type)              , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [15 ] = { RW_ATTRX(analogInput3Type)              , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [16 ] = { RW_ATTRX(analogInput4Type)              , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 2 },
    ...
    [21 ] = { RW_ATTRX(temp1DeltaThresh)              , u16, y, n, n, n, AttributeValidator_uint16   , 0, 255 },
    ...
    [26 ] = { RW_ATTRX(temp2DeltaThresh)              , u16, y, n, n, n, AttributeValidator_uint16   , 0, 255 },
    ...
    [31 ] = { RW_ATTRX(temp3DeltaThresh)              , u16, y, n, n, n, AttributeValidator_uint16   , 0, 255 },
    ...
    [36 ] = { RW_ATTRX(temp4DeltaThresh)              , u16, y, n, n, n, AttributeValidator_uint16   , 0, 255 },
    [37 ] = { RW_ATTRX(highAnalog1Thresh1)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [38 ] = { RW_ATTRX(highAnalog1Thresh2)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [39 ] = { RW_ATTRX(lowAnalog1Thresh1)             , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [40 ] = { RW_ATTRX(lowAnalog1Thresh2)             , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [41 ] = { RW_ATTRX(analog1DeltaThresh)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [42 ] = { RW_ATTRX(highAnalog2Thresh1)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [43 ] = { RW_ATTRX(highAnalog2Thresh2)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [44 ] = { RW_ATTRX(lowAnalog2Thresh1)             , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [45 ] = { RW_ATTRX(lowAnalog2Thresh2)             , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [46 ] = { RW_ATTRX(analog2DeltaThresh)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [47 ] = { RW_ATTRX(highAnalog3Thresh1)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [48 ] = { RW_ATTRX(highAnalog3Thresh2)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [49 ] = { RW_ATTRX(lowAnalog3Thresh1)             , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [50 ] = { RW_ATTRX(lowAnalog3Thresh2)             , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [51 ] = { RW_ATTRX(analog3DeltaThresh)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [52 ] = { RW_ATTRX(highAnalog4Thresh1)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    [53 ] = { RW_ATTRX(highAnalog4Thresh2)            , u16, y, n, n, n, AttributeValidator_uint16   , 0, 4096 },
    ...
    [61 ] = { RW_ATTRX(configVersion)                 , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 255 },
    [62 ] = { RW_ATTRX(configType)                    , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 255 },
    [63 ] = { RW_ATTRX(hardwareMinorVersion)          , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 9 },
    ...
    [69 ] = { RW_ATTRX(thermistorIndex)               , u8 , y, n, n, n, AttributeValidator_uint8    , 0, 3 },
    ...
    [74 ] = { RO_ATTRX(batteryVoltageMv)              , u16, n, n, n, n, AttributeValidator_uint16   , 0, 3800 },
    [75 ] = { RO_ATTRX(digitalInput1Alarm)            , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 0 },
    [76 ] = { RO_ATTRX(digitalInput2Alarm)            , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 0 },
    [77 ] = { RO_ATTRX(currentReadingMa)              , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 20 },
    [78 ] = { RO_ATTRX(highTemperature1Alarm)         , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [79 ] = { RO_ATTRX(lowTemperature1Alarm)          , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [80 ] = { RO_ATTRX(deltaTemperature1Alarm)        , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [81 ] = { RO_ATTRX(highTemperature2Alarm)         , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [82 ] = { RO_ATTRX(lowTemperature2Alarm)          , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [83 ] = { RO_ATTRX(deltaTemperature2Alarm)        , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [84 ] = { RO_ATTRX(highTemperature3Alarm)         , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [85 ] = { RO_ATTRX(lowTemperature3Alarm)          , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [86 ] = { RO_ATTRX(deltaTemperature3Alarm)        , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [87 ] = { RO_ATTRX(highTemperature4Alarm)         , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [88 ] = { RO_ATTRX(lowTemperature4Alarm)          , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [89 ] = { RO_ATTRX(deltaTemperature4Alarm)        , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [90 ] = { RO_ATTRX(highAnalog1Alarm)              , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [91 ] = { RO_ATTRX(lowAnalog1Alarm)               , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [92 ] = { RO_ATTRX(deltaAnalog1Alarm)             , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [93 ] = { RO_ATTRX(highAnalog2Alarm)              , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [94 ] = { RO_ATTRX(lowAnalog2Alarm)               , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [95 ] = { RO_ATTRX(deltaAnalog2Alarm)             , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    [96 ] = { RO_ATTRX(highAnalog3Alarm)              , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [97 ] = { RO_ATTRX(lowAnalog3Alarm)               , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 2 },
    [98 ] = { RO_ATTRX(deltaAnalog3Alarm)             , u8 , n, n, n, n, AttributeValidator_uint8    , 0, 1 },
    ...
    [113] = { RO_ATTRX(batteryAge)                    , u32, n, n, n, n, AttributeValidator_uint32   , 0, 0 },
    [114] = { RO_ATTRX(upTime)                        , u64, n, n, n, n, AttributeValidator_uint64   , 0, 0 },
