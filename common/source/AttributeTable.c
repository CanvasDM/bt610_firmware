...
AttributeEntry_t attrTable[ATTR_TABLE_SIZE] = {
    ...
    [57 ] = { RW_ATTRX(activeMode)                    , b  , y, y, y, n, y, n, AttributeValidator_cp8      , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
    [58 ] = { RW_ATTRX(useCodedPhy)                   , b  , y, y, y, y, y, n, AttributeValidator_bool     , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
    [59 ] = { RW_ATTRX(txPower)                       , u8 , y, y, y, n, y, n, AttributeValidator_uint8    , NULL                                      , .min.ux = 0.0       , .max.ux = 13.0       },
    ...
    [62 ] = { RW_ATTRX(configType)                    , u8 , y, y, y, y, y, n, AttributeValidator_uint8    , NULL                                      , .min.ux = 0.0       , .max.ux = 6.0        },
    ...
    [69 ] = { RW_ATTRX(thermistorConfig)              , u8 , y, y, y, y, y, n, AttributeValidator_uint8    , NULL                                      , .min.ux = 0.0       , .max.ux = 15.0       },
    ...
    [85 ] = { RW_ATTRX(analogInput1Type)              , u8 , y, y, y, y, y, n, AttributeValidator_aic      , NULL                                      , .min.ux = 0.0       , .max.ux = 7.0        },
    [86 ] = { RW_ATTRX(analogInput2Type)              , u8 , y, y, y, y, y, n, AttributeValidator_aic      , NULL                                      , .min.ux = 0.0       , .max.ux = 7.0        },
    [87 ] = { RW_ATTRX(analogInput3Type)              , u8 , y, y, y, y, y, n, AttributeValidator_aic      , NULL                                      , .min.ux = 0.0       , .max.ux = 7.0        },
    [88 ] = { RW_ATTRX(analogInput4Type)              , u8 , y, y, y, y, y, n, AttributeValidator_aic      , NULL                                      , .min.ux = 0.0       , .max.ux = 7.0        },
    ...
    [95 ] = { RW_ATTRX(qrtcLastSet)                   , u32, y, n, y, n, y, n, AttributeValidator_uint32   , NULL                                      , .min.ux = 0.0       , .max.ux = 0.0        },
    ...
    [167] = { RO_ATTRX(mobileAppDisconnect)           , b  , n, y, y, n, y, n, AttributeValidator_bool     , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
    [168] = { RO_ATTRX(attrSaveErrorCode)             , i32, n, n, y, n, y, n, AttributeValidator_int32    , NULL                                      , .min.ux = 0.0       , .max.ux = 0.0        },
    [169] = { RO_ATTRX(settingsPasscodeStatus)        , u8 , n, n, y, n, n, n, AttributeValidator_uint8    , NULL                                      , .min.ux = 0.0       , .max.ux = 2.0        }
    /* pyend */
};
/* clang-format on */
