...
AttributeEntry_t attrTable[ATTR_TABLE_SIZE] = {
    ...
    [13 ] = { RW_ATTRX(analogInput1Type)              , u8 , y, n, n, y, n, AttributeValidator_aic      , 0, 4 },
    [14 ] = { RW_ATTRX(analogInput2Type)              , u8 , y, n, n, y, n, AttributeValidator_aic      , 0, 4 },
    [15 ] = { RW_ATTRX(analogInput3Type)              , u8 , y, n, n, y, n, AttributeValidator_aic      , 0, 4 },
    [16 ] = { RW_ATTRX(analogInput4Type)              , u8 , y, n, n, y, n, AttributeValidator_aic      , 0, 4 },
    ...
    [112] = { RW_ATTRX(ainSelects_deprecated)         , u8 , y, n, n, y, y, AttributeValidator_uint8    , 0, 15 },
