...
static const RwAttribute_t DEFAULT_RW_ATTRIBUTE_VALUES = {
	...
	.highAnalog1Thresh1 = 0,
	.highAnalog1Thresh2 = 0,
	.lowAnalog1Thresh1 = 0,
	.lowAnalog1Thresh2 = 0,
	.analog1DeltaThresh = 0,
	.highAnalog2Thresh1 = 0,
	.highAnalog2Thresh2 = 0,
	.lowAnalog2Thresh1 = 0,
	.lowAnalog2Thresh2 = 0,
	.analog2DeltaThresh = 0,
	.highAnalog3Thresh1 = 0,
	.highAnalog3Thresh2 = 0,
	.lowAnalog3Thresh1 = 0,
	.lowAnalog3Thresh2 = 0,
	.analog3DeltaThresh = 0,
	.highAnalog4Thresh1 = 0,
	.highAnalog4Thresh2 = 0,
	.lowAnalog4Thresh1 = 0,
	.lowAnalog4Thresh2 = 0,
	.analog4DeltaThresh = 0,
	.activeMode = 0,
	.useCodedPhy = 1,
	.txPower = 0,
	.networkId = 0,
...
AttributeEntry_t attrTable[ATTR_TABLE_SIZE] = {
	...
	[37 ] = { RW_ATTRX(highAnalog1Thresh1)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[38 ] = { RW_ATTRX(highAnalog1Thresh2)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[39 ] = { RW_ATTRX(lowAnalog1Thresh1)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[40 ] = { RW_ATTRX(lowAnalog1Thresh2)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[41 ] = { RW_ATTRX(analog1DeltaThresh)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[42 ] = { RW_ATTRX(highAnalog2Thresh1)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[43 ] = { RW_ATTRX(highAnalog2Thresh2)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[44 ] = { RW_ATTRX(lowAnalog2Thresh1)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[45 ] = { RW_ATTRX(lowAnalog2Thresh2)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[46 ] = { RW_ATTRX(analog2DeltaThresh)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[47 ] = { RW_ATTRX(highAnalog3Thresh1)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[48 ] = { RW_ATTRX(highAnalog3Thresh2)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[49 ] = { RW_ATTRX(lowAnalog3Thresh1)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[50 ] = { RW_ATTRX(lowAnalog3Thresh2)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[51 ] = { RW_ATTRX(analog3DeltaThresh)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[52 ] = { RW_ATTRX(highAnalog4Thresh1)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[53 ] = { RW_ATTRX(highAnalog4Thresh2)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[54 ] = { RW_ATTRX(lowAnalog4Thresh1)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[55 ] = { RW_ATTRX(lowAnalog4Thresh2)             , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	[56 ] = { RW_ATTRX(analog4DeltaThresh)            , f  , y, y, y, y, y, n, n, AttributeValidator_float           , NULL                                      , .min.fx = 0.0       , .max.fx = 15000.0    },
	...
	[61 ] = { RO_ATTRX(configVersion)                 , u8 , n, n, y, n, y, n, n, AttributeValidator_uint8           , NULL                                      , .min.ux = 0.0       , .max.ux = 255.0      },
	...
	[80 ] = { RO_ATTRX(analogInput1)                  , f  , n, n, y, n, n, n, n, AttributeValidator_float           , AttributePrepare_analogInput1             , .min.fx = 0.0       , .max.fx = 15000.0    },
	[81 ] = { RO_ATTRX(analogInput2)                  , f  , n, n, y, n, n, n, n, AttributeValidator_float           , AttributePrepare_analogInput2             , .min.fx = 0.0       , .max.fx = 15000.0    },
	[82 ] = { RO_ATTRX(analogInput3)                  , f  , n, n, y, n, n, n, n, AttributeValidator_float           , AttributePrepare_analogInput3             , .min.fx = 0.0       , .max.fx = 15000.0    },
	[83 ] = { RO_ATTRX(analogInput4)                  , f  , n, n, y, n, n, n, n, AttributeValidator_float           , AttributePrepare_analogInput4             , .min.fx = 0.0       , .max.fx = 15000.0    },
	...
	[89 ] = { RO_ATTRX(flags)                         , u32, n, n, y, n, y, n, n, AttributeValidator_uint32          , NULL                                      , .min.ux = 0.0       , .max.ux = 0.0        },
	...
	[127] = { RO_ATTRX(voltage1SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[128] = { RO_ATTRX(voltage2Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[129] = { RO_ATTRX(voltage2SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[130] = { RO_ATTRX(voltage3Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[131] = { RO_ATTRX(voltage3SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[132] = { RO_ATTRX(voltage4Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[133] = { RO_ATTRX(voltage4SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[134] = { RO_ATTRX(ultrasonicSimulated)           , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[135] = { RO_ATTRX(ultrasonicSimulatedValue)      , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[136] = { RO_ATTRX(pressureSimulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[137] = { RO_ATTRX(pressureSimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[138] = { RO_ATTRX(current1Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[139] = { RO_ATTRX(current1SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[140] = { RO_ATTRX(current2Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[141] = { RO_ATTRX(current2SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[142] = { RO_ATTRX(current3Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[143] = { RO_ATTRX(current3SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[144] = { RO_ATTRX(current4Simulated)             , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[145] = { RO_ATTRX(current4SimulatedValue)        , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[146] = { RO_ATTRX(vrefSimulated)                 , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[147] = { RO_ATTRX(vrefSimulatedValue)            , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[148] = { RO_ATTRX(temperature1Simulated)         , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[149] = { RO_ATTRX(temperature1SimulatedValue)    , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
	[150] = { RO_ATTRX(temperature2Simulated)         , b  , n, y, y, n, n, n, y, AttributeValidator_bool            , NULL                                      , .min.ux = 0.0       , .max.ux = 1.0        },
	[151] = { RO_ATTRX(temperature2SimulatedValue)    , f  , n, y, y, n, n, n, y, AttributeValidator_float           , NULL                                      , .min.fx = -3.4e+38  , .max.fx = 3.4e+38    },
