...
AttributeEntry_t attrTable[ATTR_TABLE_SIZE] = {
	...
	[21 ] = { RW_ATTRX(temp_1_delta_thresh)           , f  , y, y, y, y, y, n, n, attribute_validator_float          , NULL                                      , .min.fx = 0         , .max.fx = 255.0      },
	...
	[26 ] = { RW_ATTRX(temp_2_delta_thresh)           , f  , y, y, y, y, y, n, n, attribute_validator_float          , NULL                                      , .min.fx = 0         , .max.fx = 255.0      },
	...
	[31 ] = { RW_ATTRX(temp_3_delta_thresh)           , f  , y, y, y, y, y, n, n, attribute_validator_float          , NULL                                      , .min.fx = 0         , .max.fx = 255.0      },
	...
	[36 ] = { RW_ATTRX(temp_4_delta_thresh)           , f  , y, y, y, y, y, n, n, attribute_validator_float          , NULL                                      , .min.fx = 0         , .max.fx = 255.0      },
